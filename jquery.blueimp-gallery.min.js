!function(t) {
    ...
    "use strict";
    function i(t, e) {
        return document.body.style.maxHeight === undefined ? null : this && this.options === i.prototype.options ? void (t && t.length ? (this.list = t,
        this.num = t.length,
        this.initOptions(e),
        this.initialize()) : this.console.log("blueimp Gallery: No or empty list provided as first argument.", t)) : new i(t,e)
    }
    return y.extend(i.prototype, {
        options: {
        ...
        support: function(s) {
            ...
            function i() {
                ...
                i && (t = i.name.slice(0, -9) + "ransform",
                s.style[t] !== undefined && (s.style[t] = "translateZ(0)",
                e = window.getComputedStyle(s).getPropertyValue(i.prefix + "transform"),
                n.transform = {
                    prefix: i.prefix,
                    name: t,
                    translate: !0,
            ...
            return document.body ? i() : y(document).on("DOMContentLoaded", i),
            n
        ...
        slide: function(t, e) {
            ...
            if (o !== t && 1 !== this.num) {
                if (e = e || this.options.transitionDuration,
                this.support.transform) {
                    for (this.options.continuous || (t = this.circle(t)),
                    i = Math.abs(o - t) / (o - t),
                    this.options.continuous && (s = i,
                    (i = -this.positions[this.circle(t)] / this.slideWidth) !== s && (t = -i * this.num + t)),
                    n = Math.abs(o - t) - 1; n; )
        ...
        play: function(t) {
            ...
            1 < this.elements[this.index] && (this.timeout = this.setTimeout(!this.requestAnimationFrame && this.slide || function(t, e) {
                i.animationFrameId = i.requestAnimationFrame.call(window, function() {
                    i.slide(t, e)
                })
            }
            , [e, this.options.slideshowTransitionDuration], this.interval)),
        ...
        pause: function() {
            window.clearTimeout(this.timeout),
            this.interval = null,
            this.cancelAnimationFrame && (this.cancelAnimationFrame.call(window, this.animationFrameId),
        ...
        add: function(t) {
            ...
            2 < this.num && null === this.options.continuous && (this.options.continuous = !0,
        ...
        close: function() {
            ...
            this.support.transition && this.options.displayTransition ? (this.container.on(this.support.transition.end, function i(t) {
                t.target === e.container[0] && (e.container.off(e.support.transition.end, i),
                e.handleClose())
            }),
        ...
        translate: function(t, e, i, s) {
            var n, o;
            this.slides[t] && (n = this.slides[t].style,
        ...
        animate: function(e, i, s) {
            ...
            a = window.setInterval(function() {
                ...
                if (s < t)
                    return n.slidesContainer[0].style.left = i + "px",
                    n.ontransitionend(),
        ...
        onmousedown: function(t) {
            t.which && 1 === t.which && "VIDEO" !== t.target.nodeName && "AUDIO" !== t.target.nodeName && (t.preventDefault(),
        ...
        onmouseout: function(t) {
            var e, i;
            this.touchStart && (e = t.target,
            (i = t.relatedTarget) && (i === e || y.contains(e, i)) || this.onmouseup(t))
        },
        ...
        ontouchmove: function(t) {
            this.options.stopTouchEventsPropagation && this.stopPropagation(t);
            var e, i, s = (t.originalEvent || t).touches, n = s[0], o = (t.originalEvent || t).scale, a = this.index;
            if (!(1 < s.length || o && 1 !== o))
                ...
                this.isScrolling)
                    ...
                    window.clearTimeout(this.timeout),
                    this.options.continuous ? i = [this.circle(a + 1), a, this.circle(a - 1)] : (this.touchDelta.x = e /= !a && 0 < e || a === this.num - 1 && e < 0 ? Math.abs(e) / this.slideWidth + 1 : 1,
                    i = [a],
                    a && i.push(a - 1),
                    a < this.num - 1 && i.unshift(a + 1)); i.length; )
                        a = i.pop(),
                        this.translateX(a, e + this.positions[a], 0)
        },
        ontouchend: function(t) {
            ...
            this.isScrolling ? l ? this.close() : this.translateY(e, 0, n) : o && !a ? (i = e + t,
            l = e - t,
            o = s * t,
            a = -s * t,
            this.options.continuous ? (this.move(this.circle(i), o, 0),
            this.move(this.circle(e - 2 * t), a, 0)) : 0 <= i && i < this.num && this.move(i, o, 0),
            this.move(e, this.positions[e] + o, n),
            this.move(this.circle(l), this.positions[this.circle(l)] + o, n),
            e = this.circle(l),
            this.onslide(e)) : this.options.continuous ? (this.move(this.circle(e - 1), -s, n),
            this.move(e, 0, n),
            this.move(this.circle(e + 1), s, n)) : (e && this.move(e - 1, -s, n),
            this.move(e, 0, n),
        ...
        oncomplete: function(t) {
            ...
            i && s && (e = this.getNodeIndex(s),
            y(s).removeClass(this.options.slideLoadingClass),
            "error" === t.type ? (y(s).addClass(this.options.slideErrorClass),
            this.elements[e] = 3) : this.elements[e] = 2,
        ...
        onkeydown: function(t) {
            ...
            case 13:
                this.options.toggleControlsOnEnter && (this.preventDefault(t),
                this.toggleControls());
                break;
            case 27:
        ...
        handleClick: function(t) {
            ...
            n(e.toggleClass) ? (this.preventDefault(t),
            this.toggleControls()) : n(e.prevClass) ? (this.preventDefault(t),
            this.prev()) : n(e.nextClass) ? (this.preventDefault(t),
            this.next()) : n(e.closeClass) ? (this.preventDefault(t),
            this.close()) : n(e.playPauseClass) ? (this.preventDefault(t),
            this.toggleSlideshow()) : s === this.slidesContainer[0] ? e.closeOnSlideClick ? (this.preventDefault(t),
            this.close()) : e.toggleControlsOnSlideClick && (this.preventDefault(t),
            this.toggleControls()) : s.parentNode && s.parentNode === this.slidesContainer[0] && e.toggleControlsOnSlideClick && (this.preventDefault(t),
            this.toggleControls())
        },
        onclick: function(t) {
            if (!(this.options.emulateTouchEvents && this.touchDelta && (20 < Math.abs(this.touchDelta.x) || 20 < Math.abs(this.touchDelta.y))))
        ...
        imageFactory: function(t, e) {
            var i, s, n, o, a, l, r, h, d = this.options, c = this, u = t, p = this.imagePrototype.cloneNode(!1);
            if ("string" != typeof u && (u = this.getItemProperty(t, d.urlProperty),
            ...
            y(p).on("load error", function m(t) {
                if (!s) {
                    ...
                    s = !0,
                    y(p).off("load error", m),
                    e(t)
                }
            }),
            n && n.length) {
                for (i = this.picturePrototype.cloneNode(!1),
                h = 0; h < n.length; h += 1)
                    i.appendChild(y.extend(this.sourcePrototype.cloneNode(!1), n[h]));
                i.appendChild(p),
                y(i).addClass(d.toggleClass)
            }
            return o && (a && (p.sizes = a),
            p.srcset = o),
            p.src = u,
            i || p
        },
        createElement: function(t, e) {
            var i = t && this.getItemProperty(t, this.options.typeProperty)
              ...
              , i = t && i.call(this, t, e);
            return i || (i = this.elementPrototype.cloneNode(!1),
            this.setTimeout(e, [{
                type: "error",
                target: i
            }])),
        ...
        loadElement: function(t) {
            this.elements[t] || (this.slides[t].firstChild ? this.elements[t] = y(this.slides[t]).hasClass(this.options.slideErrorClass) ? 3 : 2 : (this.elements[t] = 1,
            y(this.slides[t]).addClass(this.options.slideLoadingClass),
            this.slides[t].appendChild(this.createElement(this.list[t], this.proxyListener))))
        },
        ...
        unloadElements: function(t, i) {
            ...
            this.iteratePreloadRange(t, function(t) {
                var e = Math.abs(t - i);
                s < e && e + s < this.num && (this.unloadSlide(t),
        ...
        getDataProperty: function(t, e) {
            ...
            i = t.dataset[i]) : t.getAttribute && (i = t.getAttribute("data-" + e.replace(/([A-Z])/g, "-$1").toLowerCase())),
            "string" == typeof i) {
        ...
        initWidget: function() {
            var e = this;
            return this.container = y(this.options.container),
...
function(t) {
    ...
    return a.extend(e, {
        createIndicator: function(t) {
            var e, i, s = this.indicatorPrototype.cloneNode(!1), n = this.getItemProperty(t, this.options.titleProperty), o = this.options.thumbnailProperty;
            return this.options.thumbnailIndicators && (e = (e = o ? this.getItemProperty(t, o) : e) === undefined && (i = t.getElementsByTagName && a(t).find("img")[0]) ? i.src : e) && (s.style.backgroundImage = 'url("' + e + '")'),
            n && (s.title = n),
        ...
        addIndicator: function(t) {
            var e;
            this.indicatorContainer.length && ((e = this.createIndicator(this.list[t])).setAttribute("data-index", t),
...
function(t) {
    ...
    return C.extend(e, {
        ...
        videoFactory: function(t, e, i) {
            var s, n, o, a = this, l = this.options, r = this.elementPrototype.cloneNode(!1), h = C(r), d = [{
                type: "error",
                target: r
            }], c = i || document.createElement("video"), u = this.elementPrototype.cloneNode(!1), p = document.createElement("a"), m = this.getItemProperty(t, l.urlProperty), y = this.getItemProperty(t, l.sourcesProperty), f = this.getItemProperty(t, l.titleProperty), g = this.getItemProperty(t, l.videoPosterProperty), v = [p];
            if (h.addClass(l.videoContentClass),
            C(p).addClass(l.videoPlayClass),
            C(u).addClass(l.videoCoverClass).hasClass(l.toggleClass) || v.push(u),
            u.draggable = !1,
            f && (r.title = f,
            p.setAttribute("aria-label", f)),
            ...
            c.play && c.pause && ((i || C(c)).on("error", function() {
                a.setTimeout(e, d)
            }).on("pause", function() {
                c.seeking || (n = !1,
                ...
                h.removeClass(a.options.videoLoadingClass).addClass(a.options.videoPlayingClass)
            }).on("play", function() {
                window.clearTimeout(a.timeout),
                n = !0,
                h.addClass(a.options.videoLoadingClass),
                a.container.hasClass(a.options.controlsClass) ? (s = !0,
                a.container.removeClass(a.options.controlsClass)) : s = !1,
                c.controls = !0,
                a.activeVideo = c
            }),
...
function(t) {
    ...
    return l.extend(o.prototype, {
        ...
        loadAPI: function() {
            var t, e, i = this, s = "https://f.vimeocdn.com/js/froogaloop2.min.js", n = document.getElementsByTagName("script"), o = n.length;
            function a() {
                !e && i.playOnReady && i.play(),
                e = !0
            }
            for (; o; )
                if (n[--o].src === s) {
    ...
    l.extend(e, {
        ...
        textFactory: function(t, e) {
            ...
            return s ? (this.getItemProperty(t, i.urlProperty) === undefined && (t[i.urlProperty] = "https://vimeo.com/" + s),
            a += 1,
            this.videoFactory(t, e, new o(i.vimeoPlayerUrl,s,i.vimeoPlayerIdPrefix + a,i.vimeoClickToPlay))) : n.call(this, t, e)
        }
    }),
    t
}),
function(t) {
    ...
    return t.extend(o.prototype, {
        ...
        loadAPI: function() {
            var t, e = this, i = window.onYouTubeIframeAPIReady, s = "https://www.youtube.com/iframe_api", n = document.getElementsByTagName("script"), o = n.length;
        ...
        onStateChange: function(t) {
            switch (window.clearTimeout(this.pauseTimeout),
            t.data) {
    ...
    t.extend(i, {
        ...
        textFactory: function(t, e) {
            ...
            return s ? (this.getItemProperty(t, i.urlProperty) === undefined && (t[i.urlProperty] = "https://www.youtube.com/watch?v=" + s),
            ...
            this.videoFactory(t, e, new o(s,i.youTubePlayerVars,i.youTubeClickToPlay))) : n.call(this, t, e)
        }
    }),
    e
}),
function(t) {
    ...
    n(document).on("click", "[data-gallery]", function(t) {
        var e = n(this).data("gallery")
          ...
          , e = n(this).closest("[data-gallery-group], body").find('[data-gallery="' + e + '"]');
        return i.filter && (e = e.filter(i.filter)),
        new o(e,i)
    })
});
